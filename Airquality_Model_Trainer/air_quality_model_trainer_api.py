...
API_KEY = '628c8e8ef73a64fc4cccfe1be336c4b9'
...
def predict_aqi():
    ...
    # Define the time range for historical data (e.g., past 60 days)
    start_time = int((current_time - datetime.timedelta(days=60)).timestamp())
...
if __name__ == '__main__':
    app.run(debug=True, host='192.168.198.150', port=5001)
